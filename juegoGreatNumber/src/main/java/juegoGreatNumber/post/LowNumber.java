...
/**
 * Servlet implementation class LowNumber
 */
@WebServlet("/LowNumber")
public class LowNumber extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher view = request.getRequestDispatcher("LowNum.jsp");
