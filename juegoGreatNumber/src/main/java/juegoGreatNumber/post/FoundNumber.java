...
@WebServlet("/FoundNumber")
public class FoundNumber extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher view = request.getRequestDispatcher("FoundNum.jsp");
		...
		//response.sendRedirect("/GreatNumber/FoundNumber");
